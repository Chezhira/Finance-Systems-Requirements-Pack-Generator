...
* [Try the live demo](https://finance-systems-requirements-pack-generator.streamlit.app/)
* [Read the case study](CASE_STUDY.md)
* [Review generated example outputs](#output-proof)
* [See the evaluation and quality gates](#evaluation-and-quality-gates)

## Output Proof

The most useful way to assess the project is not by reading the code first, but by reviewing the generated artefacts. The repository includes sample requirements packs, control-risk matrices, process flows, and readiness packs generated by the same deterministic pipeline used in the live app.

Recommended examples to review first:

* **Month-end Close** - strongest fit for close ownership, reconciliations, journals, evidence, and readiness.
* **Accounts Payable** - strongest fit for supplier controls, approval routing, three-way match readiness, payment evidence, and segregation of duties.

| Reviewer artefact | Example |
| --- | --- |
| Month-end Close requirements pack | [DOCX](examples/generated_packs/month_end_close_requirements_pack.docx) and [Markdown](examples/generated_packs/month_end_close_requirements_pack.md) |
| Accounts Payable requirements pack | [DOCX](examples/generated_packs/accounts_payable_requirements_pack.docx) and [Markdown](examples/generated_packs/accounts_payable_requirements_pack.md) |
...
The eval suite checks whether generated finance artefacts meet finance-specific quality rules: every pack has the expected structure, IDs remain unique, traceability is present, controls have owners and evidence, readiness checks default to reviewable status, exports generate successfully, public-safe assumptions hold, and deterministic generation remains stable.
...
docs/
  reviewer_launch_checklist.md
  social_preview_notes.md
...
Added finance-specific evals for structure, ID uniqueness, traceability, control coverage, readiness completeness, export integrity, public-safe content checks, and deterministic generation.
